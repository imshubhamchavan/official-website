...
export default function Contact() {
  return (
    <div>
      <div className="flex flex-col items-center mb-12 text-center text-5xl md:text-6xl lg:text-12xl">
      ...
      <div className="max-w-7xl w-full px-4 md:px-8 mx-auto pt-32">
        <h1 className="text-right text-4xl md:text-4xl font-small lg:text-5xl">
          Contact Me
        </h1>

        <div className="h-28 sm:h-48 border-r flex justify-center items-center border-white mt-4"></div>
      </div>
      ...
      <div className=" pb-32 max-w-7xl w-full px-4 md:px-8 mx-auto mt-32 text-center text-2xl md:text-2xl lg:text-3xl cinzel-about">
        {" "}
